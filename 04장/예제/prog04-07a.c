...
{ 	
	...
	int limit = 20;													/* 의사난수의 최대값 			*/

	srand(time(NULL)); 												/* 현재 시간을 초기값으로 활용	*/
	chosen = 1 + rand()%limit; 										/* 1 이상 limit 이하의 난수 	*/

	printf("\n행운번호 맞히기 게임입니다."); 
	printf("\n컴퓨터가 1번부터 20번 가운데 하나를 추첨합니다. 이 번호를 맞혀보세요.\n"); 
